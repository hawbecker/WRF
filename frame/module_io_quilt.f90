...
integer , DIMENSION(max_domains) :: mcm_opt
logical , DIMENSION(max_domains) :: mcm_link_rad
logical , DIMENSION(max_domains) :: mcm_use_3d_lad
integer , DIMENSION(max_domains) :: mcm_model
integer , DIMENSION(max_domains) :: scpm_jdm_opt
integer , DIMENSION(max_domains) :: scpm_nb
integer , DIMENSION(max_domains) :: scpm_sb
integer , DIMENSION(max_domains) :: scpm_eb
integer , DIMENSION(max_domains) :: scpm_wb
integer , DIMENSION(max_domains) :: m_pblh_opt
...
NAMELIST /physics/ mcm_opt
NAMELIST /physics/ mcm_link_rad
NAMELIST /physics/ mcm_use_3d_lad
NAMELIST /physics/ mcm_model
NAMELIST /dynamics/ scpm_jdm_opt
NAMELIST /dynamics/ scpm_nb
NAMELIST /dynamics/ scpm_sb
NAMELIST /dynamics/ scpm_eb
NAMELIST /dynamics/ scpm_wb
NAMELIST /dynamics/ m_pblh_opt
