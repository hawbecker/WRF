...
integer                                  :: mcm_opt
logical                                  :: mcm_link_rad
logical                                  :: mcm_use_3d_lad
real                                     :: cht
integer                                  :: mcm_model
real                                     :: prtz
integer                                  :: prtnk
integer                                  :: scpm_jdm_opt
integer                                  :: scpm_nb
integer                                  :: scpm_sb
integer                                  :: scpm_eb
integer                                  :: scpm_wb
...
real      ,DIMENSION(:,:)     ,POINTER   :: coszr
real      ,DIMENSION(:,:)     ,POINTER   :: rswdir_htop_vis
real      ,DIMENSION(:,:)     ,POINTER   :: rswdir_htop_red
real      ,DIMENSION(:,:)     ,POINTER   :: rswdif_htop_vis
real      ,DIMENSION(:,:)     ,POINTER   :: rswdif_htop_red
real      ,DIMENSION(:,:)     ,POINTER   :: rlwd_htop
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_tlai
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_sw
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_lw
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_sh
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_le
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_co2_tend
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_qv_tend
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_t_tend
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_q_source
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_co2_source
real      ,DIMENSION(:,:)     ,POINTER   :: mcm_le_grnd
real      ,DIMENSION(:,:)     ,POINTER   :: mcm_sh_grnd
real      ,DIMENSION(:,:)     ,POINTER   :: mcm_sw_in
real      ,DIMENSION(:,:)     ,POINTER   :: mcm_sw_out
real      ,DIMENSION(:,:)     ,POINTER   :: mcm_lw_in
real      ,DIMENSION(:,:)     ,POINTER   :: mcm_lw_out
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_tau13_t
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_tau13_q
real      ,DIMENSION(:,:,:)   ,POINTER   :: mcm_tau13_c
real      ,DIMENSION(:,:,:)   ,POINTER   :: www
real      ,DIMENSION(:,:,:)   ,POINTER   :: cd_pan
real      ,DIMENSION(:,:,:)   ,POINTER   :: lad_3d
real      ,DIMENSION(:,:)     ,POINTER   :: canopyz_2d
real      ,DIMENSION(:)       ,POINTER   :: lad_z_3d
real      ,DIMENSION(:,:,:)   ,POINTER   :: pert_t
real      ,DIMENSION(:)       ,POINTER   :: prttms
real      ,DIMENSION(:)       ,POINTER   :: prtdt
real      ,DIMENSION(:)       ,POINTER   :: prtk
integer   ,DIMENSION(:)       ,POINTER   :: prtseed
real      ,DIMENSION(:,:)     ,POINTER   :: m_pblh
